...
func _on_activate_pebble_pressed() -> void:
	$Background/ActivatePebble.hide()
	$Background/Pebble.show()
...
func reset():
	$Background/ActivatePebble.show()
	$Background/Pebble.position = Vector2(651, 349)
	$Background/Pebble.hide()
